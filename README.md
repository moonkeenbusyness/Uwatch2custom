Uwatch2 Espruino Legacy DFU
===========================

このレポジトリは、UMIDIGI Uwatch2 / nRF52832 に Espruino を導入するための
Legacy DFU build 用 fork です。
...
3. releasesのzipかこのレポジトリで Uwatch2 用 Espruino application zip を build する
4. Android の nRF Device Firmware Updateで生成した zip を書き込む
...
この fork 固有の詳しいメモは
[UWATCH2_ESPRUINO_DFU.md](UWATCH2_ESPRUINO_DFU.md) にあります。
